						...
						<div id="chatView" class="chatbox__support">
							<div class="chatbox__header">
								<div class="chatbox__image--header">
									<img src="/images${member.member_photo}" alt="image"
...
<!-- 								<a class="chatbox__send--footer" onclick="closeWebSocket()"> X </a><br/> -->
								<a class="chatbox__send--footer" onclick="keyin1()"> 1 </a><br>
								<a class="chatbox__send--footer" onclick="keyin2()"> 2 </a><br>
								<a class="chatbox__send--footer" onclick="keyin3()"> 3 </a><br>
