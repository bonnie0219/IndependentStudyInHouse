...
<ul class="navbar-nav flex-row justify-content-xl-end d-flex flex-wrap text-body py-2 navbar-right">
<li class="nav-item">
...
<li class="nav-item">
<a class="nav-link position-relative px-3 menu-cart" href="cart.html">
<i class="far fa-shopping-basket"></i>
<span class="position-absolute number">0</span>
</a>
</li>
            ...
            <div class="carousel-project owl-carousel">
            	<div class=""> <!--拿-->
            		<div class=""><!--拿-->
		    					<div class="img">
									...
									<button type="button" id="button1" onclick="myFunction()"><img src="/images/沙發打5折.png" class="img-fluid" alt="Colorlib Template"></button>
			    				...
			    				<div class="text px-4">
			    					<h3><a href="#">凡購買沙發類商品，該商品5折</a></h3>
			    					<span>使用期限2021/08/01~2021/08/05</span>
			    				</div>
		    				</div>
            	</div>
            	<div class="item">
            		<div class="project">
			    				...
			    				<div class="text px-4">
			    					<h3><a href="#">凡購買沙發類商品，該品項一律6折</a></h3>
			    					<span>使用期限2021/08/01~2021/08/05</span>
			    				</div>
		    				</div>
            	</div>
            	<div class="item">
            		<div class="project">
			    				...
			    				<div class="text px-4">
			    					<h3><a href="#">凡購買桌子類商品 總金額折價50元</a></h3>
			    					<span>使用期限2021/08/01~2021/08/05</span>
			    				</div>
		    				</div>
            	</div>
            	<div class="item">
            		<div class="project">
			    				...
			    				<div class="text px-4">
			    					<h3><a href="#">新會員享任一訂單折100元優惠一次</a></h3>
			    					<span>使用期限2021/08/01~2021/08/05</span>
			    				</div>
		    				</div>
            	</div>
...
<li class="breadcrumb-item"><a href="#"> 專欄連結 </a></li>
