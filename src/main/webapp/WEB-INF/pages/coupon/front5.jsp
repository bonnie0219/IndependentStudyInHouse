            ...
            <section class="pt-10 pb-10">
                <div class="container">
                    ...
                    <section class="py-10 pb-lg-13">
                        <div class="container">
                            <h2 class="fs-sm-40 mb-11 text-center">客戶條款</h2>
                            <img src="/images/b-26.jpg" alt="Frequently Asked Questions" class="mb-10">
                            <div class="row no-gutters">
                                <div class="col-lg-8 mx-auto">
                                    <p class="fs-20 text-primary font-weight-500 mb-6" style="color:red" >有效日期: 請參考優惠券正面資訊

                                        每張商品抵用券面額為正面所顯示。</p>
                                    <p class="mb-7" style="color:black">商品抵用券使用方式及注意事項:</p>

                                    <p class="mb-7" style="color:black"> 1. 本券全台門市均可使用，且不限商品使用(特價品或福利品皆可抵用)。</p>

                                    <p class="mb-7" style="color:black"> 2. 本券限會員兌換，一張限換一次，並由門市人員回收。</p>

                                    <p class="mb-7" style="color:black"> 3. 本券不得轉售、兌換現金、找零或折換其他贈品，也不可抵用維修費及運費。</p>

                                    <p class="mb-7" style="color:black"> 4. 非新品瑕疵欲退換貨，本抵用券即失效，需補足商品價差。</p>

                                    <p class="mb-7" style="color:black"> 5. 僅適用於該活動期間，逾期無效。</p>

                                    <p class="mb-7" style="color:black"> 6. 本券若被盜用、遺失，恕無法補發。</p>

                                    <p class="mb-7" style="color:black"> 7. 不得與其他折扣、優惠、行銷活動合併使用。</p>

                                    <p class="mb-7" style="color:black"> 8. 本券為贈品，係屬無償取得，不適用商品（服務）禮券記載之規範。</p>

                                    <p class="mb-7" style="color:black"> 9. 使用本券為非發票交易，該訂單應以「購買時實際支付的金額」開立發票金額。</p>

                                    <p class="mb-7" style="color:black"> 10.本券須蓋有公司鋼印始生效力，並應妥善保管，若有破損、無法辨識，影印者無效。</p>

                                    <p class="mb-7" style="color:black"	> 11.本公司保留活動調整及變更商品抵用券贈送辦法及折抵方式的權利，如有變動請以本公司網站 http://localhost:8080/inhouse/homepage公告為主。</p>
                                ...
                                <div class="card border-0 pt-5 pb-7 h-100">
                                    ...
                                    <div class="card-header bg-transparent py-0 px-6">
                                        ...
                                        <p class="fs-15 text-primary"><span class="d-inline-block mr-2 fs-14"><i
                                            ...
                                            Your cart is saved for the next <span class="font-weight-500">4m34s</span>
                                        </p>
                                    </div>
                                        ...
                                        <div class="mb-6 d-flex">
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p
                                                        class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">
                                                        chairs</p>
                                                    <a href="#" class="font-weight-bold mb-3 d-block">Partridge Bar
                                                        Stool</a>
                                                    <div class="d-flex align-items-center">
                                                        <div class="input-group position-relative">
                                                            ...
                                                            <input type="number" class="w-100px px-6 text-center"
                                                                value="1">
                                                            <a href="#"
                                            ...
                                            <div class="media">
                                                ...
                                                <div class="media-body">
                                                    <p
                                                        class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">
                                                        Table</p>
                                                    <a href="#" class="font-weight-bold mb-3 d-block">Partridge Round
                                                        Bar</a>
                                                    <div class="d-flex align-items-center">
                                                        <div class="input-group position-relative">
                                                            <a href="#"
