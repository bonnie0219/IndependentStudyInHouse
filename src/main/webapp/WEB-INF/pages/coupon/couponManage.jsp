...
<head>
    ...
    <title>Blog Layout 02 - Furnitor</title>
<script	src="https://ajax.googleapis.com/ajax/libs/jquery/3.6.0/jquery.min.js"></script> 
    ...
    <meta name="twitter:title" content="Blog Layout 02">
    <meta name="twitter:description" content="Furniture Shop Html Template">
    <meta name="twitter:image" content="/images/logo_01.png">

    <meta property="og:url" content="blog-layout-02.html">
    <meta property="og:title" content="Blog Layout 02">
...
$('#start123').empty(""); 
	...
	"    <div class=\"col-md-6 pr-md-8\" style=\"margin-top: 40px;\"> "+
	 "       <a href=\"blog-post-01.html\" class=\"hover-shine d-block\"> "+
	  " <img src=\"/images"+n.coupon_photo+"\" alt=\"Under the sun in Cape Town\" id=\"sofaimg\">" +
	   "     </a>    "+       
	   " </div> "+
	   " <div class=\"col-md-6\"> "+
	   ...
	   "     <p      class=\"card-text fs-12 mb-2 text-muted lh-12 text-uppercase letter-spacing-05 font-weight-500\">  "+
	     ...
	     "       <h3 class=\"card-title mb-3 fs-20\"> "+
	         "       <a href=\"blog-post-01.html\" >" + n.coupon_name+ "</a>"+
	         "   </h3>"+
	       "     <p class=\"card-text mb-4\">" + n.coupon_rule  +"</p>"+
	          "  <a href=\"blog-post-01.html\"    class=\"fs-14 font-weight-bold border-bottom border-light-dark text-uppercase letter-spacing-05 d-inline-block border-hover-primary\"> "+
	               " 使用條款...增頁"+
	         "   </a>"+
	     "   </div>"+
	   " </div>"+
...
// 	$('#sofaname').text(n.coupon_name);
// 	$('#sofaname2').text(n.coupon_name);
// 	$('#sofarule').text(n.coupon_rule);
// 	$('#sofatime1').text(n.coupon_starttime);
// 	$('#sofatime2').text(n.coupon_endtime);
	
// 	$('#sofaimg')[0].src="/images/coupon/沙發打8折.png";
// 	                    //"/images/coupon/沙發打8折.png"
// 	console.log("\"/images"+n.coupon_photo+"\"");
	 
// 	$('#sofaimg2')[0].src="/images/coupon/沙發打8折.png";                    
...
<body>
                                                        ...
                                                        <div class="col-4 h-100">
                                                            <div class="card border-0 mt-2">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <p
                                                                        class="text-white font-weight-500 text-center mb-0">
                                                                        Spring Season
                                                                    </p>
                                            ...
                                            <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                                <li class="dropdown-item dropdown dropright">
                                                    ...
                                                    <ul
                                                        ...
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="about-us-01.html">About Us
                                                                01</a>
                                                        </li>
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="about-us-02.html">About Us
                                                                02</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                            ...
                                            <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
                                                <li class="dropdown-item dropdown dropright">
                                                    ...
                                                    <ul
                                                        class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3 x-animated x-fadeInLeft">
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-layout-01.html">Blog
                                                                Layout 01</a>
                                                        </li>
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-layout-02.html">Blog
                                                                Layout 02</a>
                                                        </li>
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-layout-03.html">Blog
                                                                Layout 03</a>
                                                        </li>
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-layout-04.html">Blog
                                                                Layout 04</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                <li class="dropdown-item dropdown dropright">
                                                    ...
                                                    <ul
                                                        class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3 x-animated x-fadeInLeft">
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-post-01.html">Blog Post
                                                                01</a>
                                                        </li>
                                                        <li class="dropdown-item">
                                                            <a class="dropdown-link" href="blog-post-02.html">Blog Post
                                                                02</a>
                                                        </li>
                                                    </ul>
                                                </li>
                                                        ...
                                                        <div class="media">
                                                            ...
                                                            <div class="media-body">
                                                                <span class="d-block lh-15">Changelog<span
                                                                        class="badge badge-success ml-2">v1.0.0</span></span>
    ...
    <main id="content">
        ...
        <section class="pt-11 pb-11 pb-lg-15">
            <div class="container">
                <h2 class="fs-sm-40 mb-11 text-center">優惠券管理</h2>
                <div class="row">
                    <div class="col-lg-3 mb-11 mb-lg-0 primary-sidebar sidebar-sticky" id="sidebar">
                            ...
                            <div class="card border-0 mb-9">
                                ...
                                <div class="card-body px-0 pt-4 pb-0">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-1">
                                            <a href="#"
                                                class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">會員贈禮</a>
                                        </li>
                                        <li class="mb-1">
                                            <a href="#"
                                                class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">折價券</a>
                                        </li>
                                        <li class="mb-1">
                                            <a href="#"
                                                class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">折扣券</a>
                                        </li>
                                        <!-- <li class="mb-1">
                            ...
                            <div class="card border-0 mb-9">
                                ...
                                <div class="card-body px-0 pt-4 pb-0">
                                    <ul class="list-unstyled mb-0">
                                        <li class="mb-6">
                                            <div class="media">
                                                <!-- <div class="mr-2 fs-15 lh-1 mt-2 text-primary"><i class="fal fa-comment-dots"></i></div> -->
                                                <!-- <div class="media-body">
<p class="mb-0 text-primary lh-175"></p>
<p class="font-weight-light text-primary lh-175 mb-0"> <a href="#" class="font-weight-bold"></a></p>
</div> -->
                                            </div>
...
<li class="mb-6">
<div class="media"> -->
                                        <!-- <a href="#" class="d-block w-70px mr-2"><img src="images/recent-post-03.jpg" alt="Sampson Totton"></a> -->
                                        <!-- <div class="media-body">
...
<li class="mb-6">
<div class="media"> -->
                                        <!-- <a href="#" class="w-70px mr-2 d-block"><img src="images/recent-post-02.jpg" alt="Sampson Totton"></a> -->
                                        <!-- <div class="media-body">
<p class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">
</p>
<a href="#" class="font-weight-bold"> </a>
...
<li class="mb-0">
<div class="media"> -->
                                        <!-- <a href="#" class="w-70px mr-2 d-block"><img src="images/recent-post-01.jpg" alt="Sampson Totton"></a> -->
                                        <!-- <div class="media-body">
<p class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">
</p> -->
                                        <!-- <a href="#" class="font-weight-bold">Black live matter</a> -->
                                        <!-- </div>
</div>
</li>
</ul>
...
<h3 class="card-title fs-18 mb-0"> -->
                                ...
                                <div class="card-body px-0 pt-6 pb-0">
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-4 item">
                                            <!-- <a href="#" class="d-block"> -->
                                            <!-- <img src="images/in_04.jpg" alt="Instagram"> -->
                                            </a>
                                        </div>
                                        <div class="col-4 item">
                                            <!-- <a href="#" class="d-block"> -->
                                            <!-- <img src="images/in_08.jpg" alt="Instagram"> -->
                                            </a>
                                        </div>
                                        <div class="col-4 item">
                                            <!-- <a href="#" class="d-block"> -->
                                    ...
                                    <!-- <a href="#" class="d-block mt-1"><span class="d-inline-block mr-1"><i class="fab fa-instagram"></i></span>@furnitor.stu</a> -->
                                </div>
                            </div>
                        </div>
                    </div>
                    <!-- 123 -->
                    <table id="showproduct" border="1"></table>123
                    
                    <div class="col-lg-9"  style="border:5px #FFAC55 solid;" id="start123" >
                        ...
                        <!-- <div class="card border-0 mb-7">
                            <div class="row no-gutters">
                                <div class="col-md-6 pr-md-8">
                                    <a href="blog-post-01.html" class="hover-shine d-block">
                                        <img src="images/blog_12.jpg" alt="Meet the Model - Tropics">
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body py-6 px-0 pb-0">
                                        ...
                                        <p class="card-text mb-4">These are beautiful, well made & ortable! I bought
                                            them to wear to work & casually. </p>
                        ...
                        <div class="card border-0 mb-7">
                            <div class="row no-gutters">
                                <div class="col-md-6 pr-md-8">
                                    <a href="blog-post-01.html" class="hover-shine d-block">
                                        <img src="images/blog_11.jpg" alt="Under the sun in Cape Town">
                                    </a>
                                </div>
                                <div class="col-md-6">
                                    <div class="card-body py-6 px-0 pb-0">
