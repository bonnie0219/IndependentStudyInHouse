...
<title>About Us 01 - Furnitor</title>
...
<meta name="twitter:title" content="About Us 01">
<meta name="twitter:description" content="Furniture Shop Html Template">
<meta name="twitter:image" content="/images/logo_01.png">

<meta property="og:url" content="about-us-01.html">
<meta property="og:title" content="About Us 01">
...
<style>
    ...
    .slide-img li{
        ...
        /* li固定寬高 */
        /* object-fit: cover; */
        flex: 1 0 0;/* 非必要不用這個 只是更確保 彈性容器 每個對應都有數字 如果cover不能用就用這個
        fex-grow flex-shrink flex-bais 伸展比例 壓縮比例 剩餘比例*/
        /* 控制元素內容調整比例 */
    }
    ...
    .slide-img li img{
        width: 100%;
        height: 100%;
        object-fit: cover;/*控制你元素大小  依照照片做比例調整填入LI*/
    }
    ...
    .pages{
        ...
        padding: 0;
        left: 0; 
        list-style: none; /*list黑點點去掉*/
        position: absolute; /*是否這個屬性讓他可以重疊在上面??*/
        bottom: 10px;
        display: flex;/*水平排列*/
        width: 100%;
    ...
    a.slide-arrow{ /*原本箭頭在上面佔了一排 箭頭先absolute絕對位置 就重疊壓在圖片下面 圖層階級*/
    /* 為什麼一次動到兩個箭頭?? 名稱不同耶 */
        position: absolute;
        /* background-color: red; */
        z-index: 10; /*圖層階級 數字越大圖層越外面*/
        width: 40px;
        height: 100%; /*同UL*/
        font-size: 36px; /*箭頭大小*/
        display: flex; /*上下致中*/
        justify-content: center; /*這室內文置中*/
        align-items: center; /*  這是物件所有對齊置中 兩個置中+display flex更好 */
        color: black;
        opacity: .6; /*改透明度 降白*/
        cursor: pointer; /*觸動範圍  滑鼠移進去會有變化 可以做電腦內建設定*/
    }
    .right{  /*slide-arrow right 全名 右邊箭頭靠右*/
        right: 0;
    }
...
<!--step3-->
 ...
 <!-- <link href="https://fonts.googleapis.com/css?family=Rubik:300,400,500,700,900" rel="stylesheet"> -->
    ...
    <!-- <link rel="stylesheet" href="css/icomoon.css">  放大點點鍵頭 -->
...
<a href="#search-popup" data-gtf-mfp="true" data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}' class="nav-search d-flex align-items-center"><i class="far fa-search"></i><span class="d-none d-xl-inline-block ml-2 font-weight-500">Search</span> </a>
</div>
</div>
...
<img src="/images/menu.jpg" alt="Image Menu" class="card-img">
<div class="card-img-overlay d-flex flex-column pt-6 pb-5">
<p class="text-white font-weight-500 text-center mb-0">
Spring Season
</p>
...
<a class="navbar-brand mx-8 mr-0 d-inline-block py-0" href="/index.html">
...
<div class="media-body">
<span class="d-block lh-15">Changelog<span class="badge badge-success ml-2">v1.0.0</span></span>
...
<li class="nav-item">
<a class="nav-link position-relative px-3 py-0" href="#"><i class="far fa-heart"></i>
...
<a href="#search-popup" data-gtf-mfp="true" data-mfp-options='{"type":"inline","focus": "#keyword","mainClass": "mfp-search-form mfp-move-from-top mfp-align-top"}' class="nav-search d-flex align-items-center"><i class="far fa-search"></i></a>
</div>
</nav>
</div>
</div>
...
<main id="content">
<section class="d-flex flex-column bg-img-cover-center vh-100 custom-height-sm pt-xxl-13" style="background-image: url('images/bg-about-us.jpg');">
...
<h1 class="fs-60 fs-lg-100 lh-1 text-center text-white">About Us</h1>
</div>
</div>
</section>
            	...
            	<div class=""> <!--拿-->
            		<div class=""><!--拿-->
				    			...
				    			<!--	<a href="images/project-1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					 <span class="icon-expand"></span>  綠色鍵頭
				    				</a>-->
			    				</div>
			    				<div class="text px-4">
           ...
           <div class="">
            ...
            <div class="carousel-project owl-carousel">
            	<div class=""> <!--拿-->
            		<div class=""><!--拿-->
		    					<div class="img">
				    				<!-- <img src="images/沙發打8折.png" class="img-fluid" alt="Colorlib Template"> -->
									<button type="button" id="button1" onclick="myFunction()"><img src="/images/沙發打8折.png" class="img-fluid" alt="Colorlib Template"></button>
				    			<!--	<a href="images/project-1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					 <span class="icon-expand"></span>  綠色鍵頭
				    				</a>-->
			    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<button type="button" id="button2" onclick="myFunction()"><img src="/images/沙發打6折.png" class="img-fluid" alt="Colorlib Template"></button>
									<!-- <button type="button" id="button1" onclick="myFunction()"><img src="images/沙發打8折.png" class="img-fluid" alt="Colorlib Template"></button> -->
				    				<!-- <a href="images/project-2.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a> -->
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
									<!-- <button type="button" id="button2" onclick="myFunction()"><img src="images/沙發打6折.png" class="img-fluid" alt="Colorlib Template"></button> -->
				    				<button type="button" id="button3" onclick="myFunction()"><img src="/images/桌子折扣50元.png" class="img-fluid" alt="Colorlib Template"></button>
				    				<!-- <a href="images/project-3.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a> -->
			    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
									<!-- <button type="button" id="button3" onclick="myFunction()"><img src="images/桌子折扣50元.png" class="img-fluid" alt="Colorlib Template"></button> -->
				    				<button type="button" id="button4" onclick="myFunction()"><img src="/images/會員贈禮.png" class="img-fluid" alt="Colorlib Template"></button>
				    				<!-- <a href="images/project-4.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a> -->
			    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				...
				    				<button type="button" id="button5" onclick="myFunction()"><img src="/images/會員贈禮2.png" class="img-fluid" alt="Colorlib Template"></button>
				    				<!-- <a href="images/project-5.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a> -->
			    				</div>
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				...
				    				<button type="button" id="button6" onclick="myFunction()"><img src="/images/會員贈禮2.png" class="img-fluid" alt="Colorlib Template"></button>
				    				<!-- <a href="images/project-6.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a> -->
			    				</div>
...
// 			   });
// 			   function clickP() { //因為bubbling 包住的關係 所以也會執行p
// 				   alert("p");   
// 				   alert("p target1="+event.target.id+   
// 				   "\np currentTarget1"+event.currentTarget.id); //idbut    currentTarget是idp
// 					 // alert(event.target)  //[object HTMLinputelement] alert只會回傳某一種"類型物件" 的字串
// 					 console.log(event.target) ;   //回傳一個標籤    回傳事件發生的元素物件 不管我按下去都是執行idbut/idp
	   
// 				  //找出繫結元素 一般target不管我執行到哪個就算我按下去那一個元素
// 			   }
	   
// 			   function clickBut() {   //參數不打event IE8也可以接收
// 				   alert("input target2="+event.target.id+
// 				   "\ninput currentTarget2="+event.currentTarget.id); //idbut 現在biding執行哪個元素 回傳細節元素 
// 				   // alert(event.target)  //HTMLinputelement [object HTMLinputelement]回傳某一種類型物件
// 				   console.log(event.target) ;   //回傳一個標籤   
// 			   }
...
//
			   ...
			   function myFunction() {   //參數不打event IE8也可以接收
				   alert("input target2="+event.target.id+
				   "\ninput currentTarget2="+event.currentTarget.id); //idbut 現在biding執行哪個元素 回傳細節元素 
				   // alert(event.target)  //HTMLinputelement [object HTMLinputelement]回傳某一種類型物件
				 //  console.log(event.target) ;   //回傳一個標籤   
             ...
             case "button1":
            	 ...
            	 $('#coupon_name').val("沙發打8折");
 			    $('#coupon_rule').val("凡購買沙發類商品，該商品8折");
 			    $('#coupon_type').val("折扣券");
 			    ...
 			    $('#coupon_photo').val("/coupon/沙發打8折.png");
 			    $('#file').val("");			   
 			    $('#member').val("1");
...
// 			    $('#coupon_name').val("333");
// 			    $('#coupon_rule').val("沙發打8折");
// 			    $('#coupon_type').val("12333沙發打8折");
// 			    $('#coupon_status').val("沙發打8折");
// 			    $('#coupon_starttime').val("1911-02-06");
// 			    $('#coupon_endtime').val("1911-02-06")
// 			    $('#coupon_count').val("112345");
// 			    $('#coupon_addtime').val("1911-02-06");
...
<p class="counterup fs-60 text-primary font-weight-500 lh-13 mb-3" data-start="0" data-end="12346" data-decimals="0" data-duration="0" data-separator=",">12346
</p>
...
<div class="mxw-814 mx-auto mb-7">
<h2 class="fs-30 fs-md-40 lh-15 text-center">Having a place set aside for an activity you
...
<p class="counterup fs-60 text-primary font-weight-500 lh-13 mb-3" data-start="0" data-end="100" data-decimals="0" data-duration="0" data-separator=",">100
</p>
...
<img src="/images/fish_bowl_lg.png" alt="Cruises & Water Tours">
</div>
...
<div class="slick-slider custom-arrow-1" data-slick-options='{"slidesToShow": 5,"infinite":true,"autoplay":true,"dots":false,"arrows":true,"responsive":[{"breakpoint": 992,"settings": {"slidesToShow":4,"dots":true,"arrows":false}},{"breakpoint": 768,"settings": {"slidesToShow": 3,"dots":true,"arrows":false}},{"breakpoint": 576,"settings": {"slidesToShow": 2,"dots":true,"arrows":false}}]}'>
<div class="box">
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-01.jpg" alt="Mattie Blooman">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Mattie Blooman</p>
</div>
</a>
</div>
<div class="box">
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-02.jpg" alt="Chioke Chinasa">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Chioke Chinasa</p>
</div>
</a>
</div>
<div class="box">
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-03.jpg" alt="Fakhri Shokoohi">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Fakhri Shokoohi</p>
</div>
</a>
</div>
<div class="box">
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-04.jpg" alt="Mattie Blooman">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Mattie Blooman</p>
</div>
...
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-05.jpg" alt="Kip Collison">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Kip Collison</p>
</div>
</a>
</div>
<div class="box">
<a href="#" class="card border-0 align-items-center">
<div class="w-130 rounded-circle overflow-hidden card-img">
<img src="/images/our-team-06.jpg" alt="Kip Collison">
</div>
<div class="card-body px-0 pt-3 pb-0">
<p class="card-title text-primary fs-18 font-weight-bold mb-0">Kip Collison</p>
</div>
...
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Seatting</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Tables</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Decoration</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Gift Ideas</a> </li>
</ul>
</div>
<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
<h3 class="fs-14 mb-3 text-uppercase letter-spacing-05">about</h3>
<ul class="list-unstyled mb-0">
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Contact Us</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Contributiors</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Privacy</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Sponsors</a> </li>
</ul>
</div>
<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
<h3 class="fs-14 mb-3 text-uppercase letter-spacing-05">follow us</h3>
<ul class="list-unstyled mb-0">
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Facebook</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Pinterest</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Instagram</a> </li>
<li class="py-0"><a href="#" class="text-gray hover-primary lh-175">Twitter</a> </li>
</ul>
</div>
<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
...
<div class="mt-0 mt-md-7 row align-items-center">
<p class="col-md-auto mb-4 mb-md-0 text-gray lh-1">
...
<p class="fs-15 text-primary"><span class="d-inline-block mr-2 fs-14"><i class="far fa-check-circle"></i></span>
...
Special instruction for seller</p>
</div>
...
<input type="text" class="form-control w-100 text-primary mb-4" placeholder="Enter coupon code here">
...
<li class="mb-1">
<a href="#" class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">Sweaters</a>
</li>
<li class="mb-1">
<a href="#" class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">Beauty</a>
</li>
<li class="mb-1">
<a href="#" class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">Fashion</a>
</li>
<li class="mb-1">
<a href="#" class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">Shopping</a>
</li>
<li class="mb-1">
<a href="#" class="text-secondary hover-primary border-bottom border-white border-hover-primary d-inline-block lh-12">Trends</a>
</li>
</ul>
</div>
</div>
...
<div class="card border-0 mb-8 widget-color">
<div class="card-header bg-transparent border-0 p-0">
<h3 class="card-title fs-18 mb-0">
Colors
</h3>
...
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #68412d;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #000000;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #aa5959;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #8db4d2;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #c2c3a0;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #c7857d;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #e3e1e7;"></a></li>
<li class="list-inline-item"><a href="#" class="d-block item" style="background-color: #b490b0;"></a></li>
</ul>
</div>
</div>
...
<div class="card-footer border-0 bg-transparent py-0 px-6">
...
<select class="selectpicker" name="category" id="region-01" data-style="btn-lg letter-spacing-0 border-0 border-bottom border-2x bg-transparent text-white border-white fs-24 pl-0 shadow-none text-capitalize font-weight-normal">
...
<p class="mb-0 text-gray">Copyright &copy; 2021.Company name All rights reserved.<a target="_blank" href="https://sc.chinaz.com/moban/">&#x7F51;&#x9875;&#x6A21;&#x677F;</a></p>
</div>
</div>
</div>
