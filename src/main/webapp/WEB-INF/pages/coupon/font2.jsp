...
<section class="pt-10 pb-10">    <!--  data-animate="fadeInUp" 為何不支援?-->
<div class="container">
<h2 class="fs-sm-40 mb-11 text-center">最新消息</h2>
<div class="row">
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/中秋.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">中秋節好禮</h3>
<p class="mb-0">中秋節當日成交任一訂單，享中秋節贈禮月餅</p>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/居家防疫.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">防疫公告</h3>
<p class="mb-0">感謝您對三越伊勢丹的支持與愛護。

    本公司謹向感染新型冠狀病毒（COVID-19）的患者致上慰問之意。
    
    同時也衷心感謝醫療現場不分晝夜盡心診察、治療病患的醫護人員。
    
    本店將於5月30日(週六)起恢復營業。</p>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/消毒.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">消毒三日公告</h3>
<p class="mb-0">實體店面停業消毒3天，從4月17日至29日只開放線上訂購。</p>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/家具展.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">台北國際家具展</h3>
<p class="mb-0">時尚設計當道，本次展覽特別邀請丹麥、德國、英國、美國、
    義大利、比利時…等國際知名設計師展示不同設計風格：極簡、樂活、
    環保、奢華、機能…等元素，滿足不同喜好的客群，為居家設計增添靈感。</p>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/家具展2.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">第27屆福爾摩莎家具展</h3>
<p class="mb-0">「第27屆福爾摩莎家具展」於8月6日～8月9日，連續四天在台北世貿一館盛大展開！本次展覽邀集業界知名優良家具廠商，從客廳、廚房、臥室，凡是居家生活空間用品一應俱全，品項齊全，價格超實惠，想找CP值超高的家具，千萬不能錯過此次難得的機會了！</p>
</div>
</div>
</div>
<div class="col-sm-6 col-lg-4 mb-6" >
<div class="card border-0">
<img src="/images/停業公告.png" alt="Cruises & Water Tours">
<div class="card-body px-0 pt-6 pb-4">
<h3 class="fs-20 mb-3">停業公告</h3>
<p class="mb-0">依中央流行疫情指揮中心防疫措施，全國有男女陪侍之酒店和舞廳自4月9日起停止營業，本市該行業別均應配合停業</p>
</div>
</div>
</div>
</div>
