...
<title>Shop Page 01 - Furnitor</title>
...
<meta property="og:url" content="shop-page-01.html">
<meta property="og:title" content="Shop Page 01">
...
<body>
	<header
		class="main-header navbar-light header-sticky header-sticky-smart">
				...
				<nav class="navbar navbar-expand-xl px-0 py-2 py-xl-0 d-block">
						...
						<div class="row align-items-center">
							<div class="col-2">
								<div class="position-relative">
									<a href="#search-popup" data-gtf-mfp="true"
										...
										class="nav-search d-flex align-items-center"><i
								...
								<div
									...
									<ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
										<li aria-haspopup="true" aria-expanded="false"
											...
											data-toggle="dropdown"> Home <span class="caret"></span>
										</a>
											<ul
												class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
												<li class="dropdown-item active"><a
													class="dropdown-link" href="index.html"> Home 01 </a></li>
												<li class="dropdown-item"><a class="dropdown-link"
													href="index.html"> Home 02 </a></li>
											</ul>
										</li>
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown-item-shop dropdown py-2 py-xl-5 px-0 px-xl-4">
											<a class="nav-link dropdown-toggle p-0" href="store.html"
											data-toggle="dropdown"> Shop <span class="caret"></span>
										</a>
											<div
												...
												<div class="container container-xxl">
													<div class="row no-gutters w-100">
														...
														<div class="col-2">
															...
															<div class="dropdown-item">
																<a class="dropdown-link" href="stores.html"> Store </a>
															</div>
															<div class="dropdown-item">
														...
														<div class="col-4 h-100">
															<div class="card border-0 mt-2">
																<img src="images/menu.jpg" alt="Image Menu"
																	class="card-img">
																<div
																	class="card-img-overlay d-flex flex-column pt-6 pb-5">
																	<p class="text-white font-weight-500 text-center mb-0">
																		Spring Season</p>
																	<h3 class="text-white fs-40 text-center">Holiday
																		Chairs</h3>
										...
										<li aria-haspopup="true" aria-expanded="false"
											...
											data-toggle="dropdown"> Pages <span class="caret"></span>
										</a>
											<ul
												class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link dropdown-toggle" href="#"
													data-toggle="dropdown"> About us </a>
													<ul
														class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3 x-animated x-fadeInLeft">
														<li class="dropdown-item"><a class="dropdown-link"
															href="about-us-01.html">About Us 01</a></li>
														<li class="dropdown-item"><a class="dropdown-link"
															href="about-us-02.html">About Us 02</a></li>
													</ul></li>
												<li class="dropdown-item"><a class="dropdown-link"
												...
												<li class="dropdown-item"><a class="dropdown-link"
													href="login-register.html"> Login Register </a></li>
											</ul>
										</li>
									</ul>
									<a class="navbar-brand mx-8 mr-0 d-inline-block py-0"
										href="index.html"> <img src="images/logo.png"
										alt="Furnitor">
									</a>
									<ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
											class="nav-link dropdown-toggle p-0" href="#"
											data-toggle="dropdown"> Contact <span class="caret"></span>
										</a>
											<ul
												class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
												<li class="dropdown-item"><a class="dropdown-link"
													href="contact-01.html"> Contact 01 </a></li>
												<li class="dropdown-item"><a class="dropdown-link"
													href="contact-02.html"> Contact 02 </a></li>
											</ul></li>
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
											class="nav-link dropdown-toggle p-0" href="#"
											data-toggle="dropdown"> Blog <span class="caret"></span>
										</a>
											<ul
												class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link dropdown-toggle" href="#"
													data-toggle="dropdown"> Blog Listing </a>
													<ul
														class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3 x-animated x-fadeInLeft">
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-layout-01.html">Blog Layout 01</a></li>
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-layout-02.html">Blog Layout 02</a></li>
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-layout-03.html">Blog Layout 03</a></li>
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-layout-04.html">Blog Layout 04</a></li>
													</ul></li>
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link dropdown-toggle" href="#"
													data-toggle="dropdown"> Blog Post </a>
													<ul
														class="dropdown-menu dropdown-submenu pt-3 pb-0 pb-xl-3 x-animated x-fadeInLeft">
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-post-01.html">Blog Post 01</a></li>
														<li class="dropdown-item"><a class="dropdown-link"
															href="blog-post-02.html">Blog Post 02</a></li>
													</ul></li>
											</ul></li>
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
											class="nav-link dropdown-toggle p-0" href="#"
											data-toggle="dropdown"> Docs <span class="caret"></span>
										</a>
											<div
												class="dropdown-menu px-0 pt-3 dropdown-menu-docs x-animated x-fadeInUp">
												<div class="dropdown-body">
													<a class="dropdown-item py-1" href="#">
														<div class="media">
															...
															<div class="media-body">
																<span class="d-block lh-15">Documentation</span> <small
																	class="d-block">Kick-start customization</small>
															</div>
														</div>
													</a>
														...
														<div class="media">
															...
															<div class="media-body">
																<span class="d-block lh-15">UI Kit<span
																	...
																	class="d-block">Flexible components</small>
															</div>
														</div>
													</a>
													<div class="dropdown-divider m-0"></div>
														...
														<div class="media">
															...
															<div class="media-body">
																<span class="d-block lh-15">Changelog<span
																	class="badge badge-success ml-2">v1.0.0</span></span> <small
																	class="d-block">Regular updates</small>
															</div>
														</div>
													</a>
													<div class="dropdown-divider m-0"></div>
													<a class="dropdown-item py-1" href="#">
														<div class="media">
															...
															<div class="media-body">
																<span class="d-block lh-15">Support</span> <small
																	class="d-block">#</small>
															</div>
														</div>
													</a>
							...
							<div class="col-2">
								<ul
									...
									<li class="nav-item"><a class="nav-link pr-3 py-0"
										href="#"> <i class="far fa-user-alt"></i>
									</a></li>
									<li class="nav-item"><a
										class="nav-link position-relative px-3 py-0" href="#"><i
											class="far fa-heart"></i> <span
											class="position-absolute number">0</span></a></li>
									<li class="nav-item"><a
										class="nav-link position-relative px-3 menu-cart py-0"
					...
					<div class="d-block d-xl-none">
						<div class="d-flex align-items-center">
							<button class="navbar-toggler border-0 px-0 canvas-toggle"
								type="button" data-canvas="true"
								data-canvas-options='{"width":"250px","container":".sidenav"}'>
								<span class="fs-24 toggle-icon"></span>
							</button>
							<div class="mx-auto">
								<a class="navbar-brand d-inline-block mr-0" href="index.html">
						...
						<div class="collapse navbar-collapse mt-3" id="primaryMenu01">
							<ul class="navbar-nav main-menu px-0 mx-xl-n4">
								<li aria-haspopup="true" aria-expanded="false"
									class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
									class="nav-link dropdown-toggle p-0" href="index.html"
									data-toggle="dropdown"> Home <span class="caret"></span>
								</a>
									<ul class="dropdown-menu pt-3 pb-0 pb-xl-3">
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-01.html"> Home 01 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-02.html"> Home 02 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-03.html"> Home 03 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-04.html"> Home 04 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-05.html"> Home 05 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-06.html"> Home 06 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-07.html"> Home 07 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-08.html"> Home 08 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-09.html"> Home 09 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-10.html"> Home 10 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-11.html"> Home 11 </a></li>
										<li class="dropdown-item"><a class="dropdown-link"
											href="home-12.html"> Home 12 </a></li>
									</ul></li>
								<li aria-haspopup="true" aria-expanded="false"
									class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
									...
									<div
										class="dropdown-menu p-0 dropdown-menu-listing x-animated x-fadeInUp">

										<h4 class="dropdown-header text-dark fs-16 my-3">Shop
											Pages</h4>

										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-01.html"> Shop
												Layout <sup>V1</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-02.html"> Shop
												Layout <sup>V2</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-03.html"> Shop
												Layout <sup>V3</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-04.html"> Shop
												Layout <sup>V4</sup>
											</a>
										</div>

										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-05.html"> Shop
												Layout <sup>V5</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-06.html"> Shop
												Layout <sup>V6</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-07.html"> Shop
												Layout <sup>V7</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-08.html"> Shop
												Layout <sup>V8</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-09.html"> Shop
												Layout <sup>V9</sup>
											</a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="shop-page-10.html"> Shop
												Layout <sup>V10</sup>
											</a>
										</div>

										<h4 class="dropdown-header text-dark fs-16 my-3">Product
											Page</h4>
										...
										<div class="dropdown-item">
											<a class="dropdown-link" href="product-page-05.html">
												Product Variable (Color/Size/etc.) </a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="product-page-07.html">
												Product Time Limit </a>
										...
										<div class="dropdown-item">
											<a class="dropdown-link" href="compare.html"> Compare </a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="stores"> Store </a>
										</div>
										<div class="dropdown-item">
											<a class="dropdown-link" href="wishlist.html"> Wishlist </a>
										</div>
									</div></li>
								<li aria-haspopup="true" aria-expanded="false"
									class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-4"><a
										...
										<div class="dropdown-body">
											...
											<a class="dropdown-item py-1" href="https://sp.g5plus.net/"
												...
												<div class="media">
													...
													<div class="media-body">
														<span class="d-block lh-15">Support</span> <small
															class="d-block">https://sp.g5plus.net/</small>
													</div>
												</div>
											</a>
										</div>
							...
							<ul
								class="navbar-nav flex-row justify-content-xl-end d-flex flex-wrap text-body py-2 navbar-right">
								<li class="nav-item"><a class="nav-link pr-3" href="#">
										<i class="far fa-user-alt"></i>
								</a></li>
								<li class="nav-item"><a
									class="nav-link position-relative px-3" href="#"><i
										class="far fa-heart"></i> <span
										class="position-absolute number">0</span></a></li>
								<li class="nav-item"><a
									class="nav-link position-relative px-3 menu-cart"
									href="cart.html"> <i class="far fa-shopping-basket"></i> <span
										class="position-absolute number">0</span>
								</a></li>
							</ul>
						</div>
		...
		<section>
			<div class="container container-xxl">
				<div class="d-flex mb-6">
					<div class="d-flex align-items-center text-primary"
						...
						<button class="navbar-toggler border-0 px-0 mr-2 canvas-filter"
							type="button">
					...
					<div class="ml-auto">
						<div class="dropdown">
							<a href="#" class="dropdown-toggle" id="dropdownMenuButton"
								...
								aria-expanded="false"> Default Sorting </a>
							<div class="dropdown-menu dropdown-menu-right"
								aria-labelledby="dropdownMenuButton" style="">
								<a class="dropdown-item text-primary" href="#">Price high to
									low</a> <a class="dropdown-item text-primary" href="#">Price
									low to high</a> <a class="dropdown-item text-primary" href="#">Random</a>
							</div>
						</div>
					</div>
				</div>
										...
										<div class="col-lg-4 col-md-4 col-sm-12 col-xs-12">
											<div class="products-single fix">
												<div class="box-img-hover">
													<img src="images/${shopSearchResult.shopPdPicture}"
												...
												<div class="why-text">
													<h4>${shopSearchResult.shopPdName}</h4>
													<h5>$ ${shopSearchResult.shopPdPrice}</h5>
												</div>
											</div>
										</div>
									</c:forEach>
			...
			<nav class="pb-11 pb-lg-14 overflow-hidden">
				<ul
					...
					<li class="page-item fs-12 d-none d-sm-block"><a
	...
	<footer class="pt-13 pb-4 footer bg-color-2">
		<div class="container container-xxl">
				...
				<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
					...
					<ul class="list-unstyled mb-0">
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Seatting</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Tables</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Decoration</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Gift Ideas</a></li>
					</ul>
				</div>
				<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
					...
					<ul class="list-unstyled mb-0">
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Contact Us</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Contributiors</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Privacy</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Sponsors</a></li>
					</ul>
				</div>
				<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
					<h3 class="fs-14 mb-3 text-uppercase letter-spacing-05">follow
						us</h3>
					<ul class="list-unstyled mb-0">
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Facebook</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Pinterest</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Instagram</a></li>
						<li class="py-0"><a href="#"
							class="text-gray hover-primary lh-175">Twitter</a></li>
					</ul>
				</div>
				<div class="col-md-6 col-lg-3 mb-6 mb-md-0">
			...
			<div class="mt-0 mt-md-7 row align-items-center">
				<p class="col-md-auto mb-4 mb-md-0 text-gray lh-1">© 2021
					Furnitor. All rights reserved.</p>
				<ul class="list-inline mb-0 col-md-6 ml-auto text-md-right">
					<li class="list-inline-item"><a href="#"><img
							src="images/card_01.png" alt="Amex"></a></li>
					<li class="list-inline-item"><a href="#"><img
							src="images/card_02.png" alt="G-Pay"></a></li>
					<li class="list-inline-item"><a href="#"><img
							src="images/card_03.png" alt="Master Card"></a></li>
					<li class="list-inline-item"><a href="#"><img
							src="images/card_04.png" alt="Paypal"></a></li>
					<li class="list-inline-item"><a href="#"><img
							src="images/card_05.png" alt="D-Pay"></a></li>
					<li class="list-inline-item"><a href="#"><img
							src="images/card_06.png" alt="V-Card"></a></li>
				</ul>
			</div>
		</div>
	</footer>
...
<path
			d="M29.867 31.963h-28.196v-4.488h28.196v4.488zM2.563 31.072h26.413v-2.705h-26.413v2.705z"></path>
<path
			d="M26.943 28.367h-22.348v-2.66h22.348v2.66zM5.487 27.475h20.565v-0.877h-20.565v0.877z"></path>
<path
			d="M11.022 26.609h-4.475v-17.882h4.475v17.882zM7.438 25.718h2.692v-16.099h-2.692v16.099z"></path>
<path
			d="M21.388 26.609h-11.236v-20.345h11.236v20.345zM11.043 25.718h9.453v-18.562h-9.453v18.562z"></path>
<path
			d="M24.992 26.609h-4.475v-17.882h4.475v17.882zM21.409 25.718h2.692v-16.099h-2.692v16.099z"></path>
<path d="M0 31.109h31.539v0.891h-31.539v-0.891z"></path>
<path
			d="M19.781 7.18h-8.023v-4.593h8.023v4.593zM12.649 6.289h6.24v-2.811h-6.24v2.811z"></path>
				...
				<div class="card-header bg-transparent py-0 px-6">
					...
					<p class="fs-15 text-primary">
						<span class="d-inline-block mr-2 fs-14"><i
							class="far fa-check-circle"></i></span> Your cart is saved for the next
						<span class="font-weight-500">4m34s</span>
					</p>
				</div>
				<div class="card-body px-6 pt-7 overflow-y-auto">
					<div class="mb-6 d-flex">
						...
						<div class="media">
							...
							<div class="media-body">
								<p
									class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">chairs</p>
								<a href="#" class="font-weight-bold mb-3 d-block">Partridge
									Bar Stool</a>
								<div class="d-flex align-items-center">
									<div class="input-group position-relative">
										<a href="#"
											class="down position-absolute pos-fixed-left-center pl-2"><i
											class="far fa-minus"></i></a> <input type="number"
											class="w-100px px-6 text-center" value="1"> <a
											href="#"
					...
					<div class="mb-6 d-flex">
						...
						<div class="media">
							...
							<div class="media-body">
								<p
									class="text-muted fs-12 mb-0 text-uppercase letter-spacing-05 lh-1 mb-1">Table</p>
								<a href="#" class="font-weight-bold mb-3 d-block">Partridge
									Round Bar</a>
								<div class="d-flex align-items-center">
									<div class="input-group position-relative">
										<a href="#"
											class="down position-absolute pos-fixed-left-center pl-2"><i
											class="far fa-minus"></i></a> <input type="number"
											class="w-100px px-6 text-center number" value="1"> <a
											href="#"
											class="up position-absolute pos-fixed-right-center pr-2"><i
											class="far fa-plus"></i> </a>
									</div>
					...
					<p class="fs-15 text-primary pt-1">
						<span class="d-inline-block mr-2 fs-14"><i
							class="fas fa-info-circle"></i></span> Special instruction for seller
					</p>
				</div>
				<div
					class="card-footer mt-auto border-0 bg-transparent px-6 pb-0 pt-5">
					<div class="d-flex align-items-center mb-4">
						<span class="font-weight-bold text-primary">Subtotal</span> <span
							class="d-block ml-auto text-primary">$2000.00</span>
					</div>
					<input type="text" class="form-control w-100 text-primary mb-4"
						placeholder="Enter coupon code here"> <input type="submit"
						class="btn btn-primary btn-block mb-2" value="Check Out">
					<a href="#"
		...
		<form class="h-100">
			<div class="card border-0 pt-5 pb-7 h-100">
				...
				<div class="card-body px-6 pt-7 overflow-y-auto">
					...
					<div class="card border-0 mb-8">
						<div class="card-header bg-transparent border-0 p-0">
							<h3 class="card-title fs-18 mb-0">Price</h3>
						</div>
						<div class="card-body px-0 pt-4 pb-0">
							<ul class="list-unstyled">
								<li class="mb-1"><a href="#"
					...
					<div class="card border-0 mb-8">
						<div class="card-header bg-transparent border-0 p-0">
							<h3 class="card-title fs-18 mb-0">Material</h3>
						</div>
						<div class="card-body px-0 pt-4 pb-0">
							<ul class="list-unstyled">
								<li class="mb-1"><a href="#"
					...
					<div class="card border-0 mb-8 widget-color">
						<div class="card-header bg-transparent border-0 p-0">
							<h3 class="card-title fs-18 mb-0">Colors</h3>
						</div>
						<div class="card-body px-0 pt-4 pb-0">
					...
					<div class="card border-0 mb-10">
						<div class="card-header bg-transparent border-0 p-0">
							<h3 class="card-title fs-18 mb-0">Tags</h3>
						</div>
						<div class="card-body px-0 pt-6 pb-0">
							<ul class="list-inline mb-0">
								<li class="list-inline-item mr-2 py-1"><a href="#"
				...
				<div class="card-footer border-0 bg-transparent py-0 px-6">
					<div class="row no-gutter mx-n2">
						<div class="col-6 px-2">
							<a href="#"
								class="btn btn-primary btn-block letter-spacing-05 text-uppercase">apply</a>
						</div>
						<div class="col-6 px-2">
							<a href="#"
								class="btn btn-outline-primary btn-block letter-spacing-05 text-uppercase">clear</a>
						</div>
					</div>
				</div>
			</div>
				...
				<ul class="navbar-nav main-menu px-0">
					...
					<li aria-haspopup="true" aria-expanded="false"
						...
						<div
							...
							<h4 class="dropdown-header text-dark fs-16 my-3">Shop Pages
							</h4>
							...
							<h4 class="dropdown-header text-dark fs-16 my-3">Shop Page</h4>
					...
					<li aria-haspopup="true" aria-expanded="false"
						...
						<ul class="dropdown-menu pt-3 pb-0 pb-xl-3">
							<li class="dropdown-item active"><a class="dropdown-link"
								href="contact-01.html"> Contact 01 </a></li>
							<li class="dropdown-item"><a class="dropdown-link"
								href="contact-02.html"> Contact 02 </a></li>
						</ul></li>
