...
$(window).scroll(function() {    
    var scroll = $(window).scrollTop();
        // $('#video1').css({'opacity':( 100-scroll )/100});
        $('#video').fadeOut();
});
</script>
</head>
...
<div id="video">
    <video  src="/images/bgvideo.mp4" autoplay loop playsinline muted ></video>
    ...
    <br>
    <br>
<!--     <button id="hide" class="viewport-header">Shop now</button> -->
</div>
    ...
    <main id="content">
        <section class="overflow-hidden">
            <div class="slick-slider custom-slider-02 mx-0 slider-01"
                    ...
                    <div class="d-flex flex-column justify-content-center bg-img-cover-center vh-100 custom-height-sm"
                        ...
                        <div class="d-flex flex-column h-100 justify-content-center">
                            <div class="container container-xxl">
                                <p class="text-primary font-weight-bold fs-24 mb-3 mb-md-6" data-animate="fadeInUp"></p>
                                <h1 class="mb-4 mb-md-9 fs-60 fs-xxl-140 heading-home-01">
                                    <strong class="d-block" data-animate="fadeInUp">Welcome</strong>
                                    <strong class="d-block" data-animate="fadeInUp">InHouse</strong>
                                </h1>
                                <a href="/inhouse/shop/queryallbypage/1"
                        ...
                        <div class="mt-auto">
                            <div class="container container-xxl">
                                <p class="text-primary mb-8">Designed by <span class="font-weight-bold">InHouse</span></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="box px-0">
                    <div class="d-flex flex-column justify-content-center bg-img-cover-center vh-100 custom-height-sm"
                        style="background-image: url('/images/homepage2.jpeg');background-position: center top;">
                        <div class="d-flex flex-column h-100 justify-content-center">
                            <div class="container container-xxl">
<!--                                 <p class="text-primary font-weight-bold fs-24 mb-3 mb-md-6">New - In</p> -->
                                <h2 class="mb-4 mb-md-8 fs-60 fs-xxl-140 lh-1">Welcome<br />
                                    InHouse</h2>
                                <a href="/inhouse/shop/queryallbypage/1"
                ...
                <div class="box px-0">
                    <div class="d-flex flex-column justify-content-center bg-img-cover-center vh-100 custom-height-sm"
                        style="background-image: url('/images/homepage3.jpeg');background-position: center top;">
                        <div class="d-flex flex-column h-100 justify-content-center">
                            <div class="container container-xxl">
<!--                                 <p class="text-primary font-weight-bold fs-24 mb-3 mb-md-6">Welcome</p> -->
                                <h2 class="mb-4 mb-md-8 fs-60 fs-xxl-140 lh-1">Welcome<br />
                                    InHouse</h2>
                                <a href="/inhouse/shop/queryallbypage/1"
                                    class="btn btn-outline-primary text-uppercase letter-spacing-05">Shop Now</a>
                ...
                <div class="d-grid g-1 g-sm-2 g-lg-4 grid-gap overflow-hidden">
                        ...
                        <div class="card border-0 hover-change-content product" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="text-uppercase text-muted letter-spacing-05 fs-12">Table</a>
                        ...
                        <div class="card border-0 hover-change-content product" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="text-uppercase text-muted letter-spacing-05 fs-12">chair</a>
                                    <p class="mt-auto text-primary mb-0">
                                        $1390.00</p>
                                </div>
                                <div class="ml-auto d-flex flex-column">
                        ...
                        <div class="card border-0 hover-change-content product" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                                <div class="d-flex flex-column">
                                    ...
                                    <a href="#" class="text-uppercase text-muted letter-spacing-05 fs-12">decor</a>
                                    <p class="mt-auto text-primary mb-0">
                                        $1390.00</p>
                                </div>
                                <div class="ml-auto d-flex flex-column">
                    ...
                    <div class="grid-item gc-sm-2  gr-start-7 gr-start-sm-4 gr-start-lg-2">
                        <div class="card border-0" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-inline-flex flex-column p-xl-8">
                                <div class="mxw-280px">
                                    <h3 class="card-title fs-48 fs-lg-40 fs-xxl-60 pt-xxl-1">Dining <br>
                                        Table</h3>
                                </div>
                                <div class="mt-auto">
                    ...
                    <div class="grid-item gc-sm-2  gc-start-lg-3 gc-end-lg-5 gr-start-14 gr-start-sm-8 gr-start-lg-4">
                        <div class="card border-0" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-inline-flex flex-column p-xl-8">
                                <div class="mxw-280px">
                                    <h3 class="card-title fs-48 fs-lg-40 fs-xxl-60 pt-xxl-6">Planters</h3>
                    ...
                    <div class="grid-item gc-sm-2  gr-start-21 gr-start-sm-12 gr-start-lg-6">
                        <div class="card border-0" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-inline-flex flex-column p-xl-8">
                                <div class="mxw-280px">
                                    <h3 class="card-title fs-48 fs-lg-40 fs-xxl-60 pt-xxl-5">Pao by <br>
                                        chiandchi</h3>
                                </div>
                                <div class="mt-auto">
                                    <a href="#" class="btn btn-outline-primary text-uppercase letter-spacing-05">shop
