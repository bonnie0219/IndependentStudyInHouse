...
<%@include file="header.jsp"%>
   ...
   <!-- 會員畫面 上方圖片 -->
    ...
    <br>
               ...
               <h3 style="text-align:center;">It's your profile:</h3>
    ...
    <br>      
        ...
        <form id="formdata">
		<table border="1"> 
		<thead ><tr><th colspan="2" style="text-align: center; background-color: #000; color: aliceblue; width: 600px;">會員簡介</th></tr></thead>
		    
			<tr>
				<td style="width:40px">會員編號</td>
				<td><input type="text" id="member_id_edit" name="member_id_edit" value="${member.member_id}" disabled style="display:none"><span>${member.member_id}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員名字</td>
				<td><input type="text" id="member_name_edit" name="member_name_edit" value="${member.member_name}" required maxlength="6" style="display:none"><span>${member.member_name}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員密碼</td>
				<td><input type="password" id="member_password_edit" name="member_password_edit" value="${member.member_password}" style="display:none"><span>${member.member_password.substring(0,5)}...</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員性別</td>
				<td><select  id="member_gender_edit" name="member_gender_edit" style="display:none" value="${member.member_gender}" style="display:none">
				<c:if test="${member.member_gender==''}"><option value="" selected></option>
								                           <option value="男">男</option>
								                           <option value="女">女</option></c:if>	
				<c:if test="${member.member_gender=='男'}"><option value=""></option>
								                           <option value="男" selected>男</option>
								                           <option value="女">女</option></c:if>	
				<c:if test="${member.member_gender=='女'}"><option value=""></option>
								                           <option value="男">男</option>
								                           <option value="女" selected>女</option></c:if>	
   
					
				    </select><span>${member.member_gender}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員信箱</td>
				<td><input type="text" id="member_email_edit" name="member_email_edit" value="${member.member_email}" style="display:none"><span>${member.member_email}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員電話</td>
				<td><input type="text" id="member_phone_edit" name="member_phone_edit" value="${member.member_phone}" style="display:none"><span>${member.member_phone}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員地址</td>
				<td><input type="text" id="member_address_edit" name="member_address_edit" value="${member.member_address}" style="display:none"><span>${member.member_address}</span></td>
			</tr>
			<tr>
				<td style="width:40px">會員生日</td>
				<td><input type="date" id="member_birthday_edit" name="member_birthday_edit" value="${member.member_birthday}" style="display:none"><span>${member.member_birthday}</span></td>
			</tr>
<!-- 			<tr> -->
<!-- 				<td>會員照片</td> -->
<!-- 				<td><img id="image_edit" alt="尚未選擇圖片" src="" style="height:100%;width:300px"><span><img src="${member.member_photo}" style="height:100%;width:300px"></span></td> -->
<!-- 			</tr> -->
			<tr>
				<td style="width:40px display:none">檔案</td>
				<td><input type="file" id="file_edit" name="file_edit" style="display:none" onchange="loadImageFile_edit(event)">
<!-- 				<img id="image_edit" alt="尚未選擇圖片" src="" style="height:100%;width:300px"> -->
				</td>
			</tr>
		...
		<br>
			    <div style="float:left"> <button type="button" class="btn btn-secondary" id="btnsavemember" value="Save" onclick ="save()" style="display:none">儲存</button></div>
		
		</form>
		
			 <button type="button" class="btn btn-secondary" id="btneditmember" value="Edit" onclick ="upd()" >修改</button>
			  <div style="float:right;margin-right:600px"><button type="button" class="btn btn-secondary" id="btncaneclmember" value="Cancel" onclick ="cancel()" style="display:none">取消修改</button></div>
