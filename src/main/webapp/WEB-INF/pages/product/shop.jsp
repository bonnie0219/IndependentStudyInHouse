                                ...
                                <div class="d-flex mt-3 mt-xl-0 align-items-center w-100 justify-content-center">
                                    ...
                                    <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                                        ...
                                        <li aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <a class="nav-link  p-0" href="http://localhost:8080/inhouse/reserve/addReserveForm" ></a>
                        ...
                        <div class="card border-0 hover-change-content product" data-animate="fadeInUp">
                            ...
                            <div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
                                <div class="d-flex flex-column">
                                    <a href="#" class="font-weight-bold mb-1 d-block lh-12">${p.product_name}</a>
        ...
        <div class="container container-xxl">
            <div class="row">
                <div class="col-lg mb-6 mb-lg-0">
                    <a href="#" class="footer-logo d-block"><img src="/images/logo.png" alt="Furnitor" style="width: 120px ;"></a>
                </div>
