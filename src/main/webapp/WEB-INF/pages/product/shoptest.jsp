...
<body>
							...
							<div class="col-xl-8 mx-auto position-static">
								<div
									...
									<ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
										...
										<li aria-haspopup="true" aria-expanded="false"
											...
											<ul
												...
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link" href="#"> 活動訊息(優惠券) </a></li>
												<li class="dropdown-item"><a class="dropdown-link"
													href="#"> 新聞 </a></li>
												<li class="dropdown-item"><a class="dropdown-link"
													href="#"> 相關連結 </a></li>
										...
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-2"><a
											class="nav-link  p-0" href="#" data-toggle="dropdown">
												設計師簡介 <span class="caret"></span>
										</a></li>
										<li aria-haspopup="true" aria-expanded="false"
											class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-2"><a
											class="nav-link  p-0" href="#" data-toggle="dropdown">
									...
									<a class="navbar-brand mx-5 mr-0 d-inline-block py-0"
										href="index.html"> <img src="/images/logo.png"
										alt="Furnitor" style="width: 75px">
									</a>
									<ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
										...
										<li aria-haspopup="true" aria-expanded="false"
											...
											<ul
												class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp">
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link" href="#" data-toggle="dropdown">
														客戶心得分享 </a></li>
												<li class="dropdown-item dropdown dropright"><a
													class="dropdown-link" href="#" data-toggle="dropdown">
														名人推薦 </a></li>
							...
							<div class="col-2">
								<ul
									...
									<li class="nav-item"><a class="nav-link pr-3 py-0"
										href="login-register.html"> <i class="far fa-user-alt"></i>
									</a></li>
									<li class="nav-item"><a
									...
									<li class="nav-item"><a
										class="nav-link position-relative px-3 menu-cart py-0 my-cart-icon"
										href="#" data-canvas="true"
										data-canvas-options='{"container":".cart-canvas"}'> <i
											class="far fa-shopping-basket"></i> <span
											class="position-absolute number my-cart-counter">0</span>
									</a></li>
								</ul>
							</div>
						<!--購物車東西結束 --><!--購物車東西結束 --><!--購物車東西結束 -->
						</div>
					</div>
	...
	<main id="content">
		<section class="overflow-hidden">
			<div class="slick-slider custom-slider-02 mx-0 slider-01"
				data-slick-options='{"slidesToShow": 1,"infinite":true,"autoplay":false,"dots":true,"arrows":false}'>
				<div class="box px-0">
					<div
						class="d-flex flex-column justify-content-center bg-img-cover-center vh-100 custom-height-sm"
						style="background-image: url('/images/bg-home-01.jpg'); background-position: center top;">

						<div class="d-flex flex-column h-100 justify-content-center">
							<div class="container container-xxl">
								<p class="text-primary font-weight-bold fs-24 mb-3 mb-md-6"
									data-animate="fadeInUp"></p>
								<h1 class="mb-4 mb-md-9 fs-60 fs-xxl-140 heading-home-01">
									<strong class="d-block" data-animate="fadeInUp">Welcom,</strong>
									<strong class="d-block" data-animate="fadeInUp">InHouse</strong>
								</h1>
								<a href="#"
						...
						<!--                         <div class="mt-auto"> -->
						<!--                             <div class="container container-xxl"> -->
						<!--                                 <p class="text-primary mb-8">Designed by <span class="font-weight-bold">Nicholas -->
				...
				<!--                         <div class="d-flex flex-column h-100 justify-content-center"> -->
				<!--                             <div class="container container-xxl"> -->
				<!--                                 <p class="text-primary font-weight-bold fs-24 mb-3 mb-md-6">New - In</p> -->
				<!--                                 <h2 class="mb-4 mb-md-8 fs-60 fs-xxl-140 lh-1">Sundae <br /> -->
				<!--                                     Lounges</h2> -->
							...
							<div class="card border-0 hover-change-content product"
								...
								<div class="card-img-overlay d-flex py-4 py-sm-5 pl-6 pr-4">
									<div class="d-flex flex-column">
										<h4 href="#" id="${p.product_name}"
											class="font-weight-bold mb-1 d-block lh-12 my-cart-id my-cart-name product">${p.product_name}</h4>
										<a href="#"
											class="text-uppercase text-muted letter-spacing-05 fs-12">${p.product_type}</a>
			...
			<div class="row">
				<div class="col-lg mb-6 mb-lg-0">
					<a href="#" class="footer-logo d-block"><img
						src="images/logo.png" alt="Furnitor"></a>
				</div>
				<div class="col-sm-８ col-lg mb-８ mb-md-0">
					<ul class="list-unstyled">
						...
						<li class="py-0"><a href="#" class="lh-213">電話：(03)4257387</a>
						</li>
						<li class="py-0"><a href="#" class="lh-213">地址：320桃園市中壢區中大路300號
								國立中央大學</a></li>
						<li class="py-0"><a href="#" class="lh-213">(工程二館側面/資策會大樓)</a>
						</li>
					</ul>
				</div>
				<div class="col-sm-８ col-lg mb-８ mb-md-0">
				...
				<div class="col-sm-6 col-lg">
					<ul class="list-inline text-lg-right">
						...
						<li class="list-inline-item"><a href="#" class="fs-20"><i
								class="fab fa-twitter"></i></a></li>
					</ul>
					<p class="mb-0 text-gray text-lg-right">
						&copy; 2021.InHouse
	...
	<svg aria-hidden="true"
        ...
        <defs>
			...
			d="M38.44 24.297c-0.297-0-0.587 0.090-0.831 0.26 0.375 0.256 0.601 0.68 0.603 1.135v5.311h1.661v-5.311c-0.012-0.781-0.653-1.405-1.434-1.395v0z">
                ...
                <path
			d="M25.669 26.881l-10.242-0.003v1.661l20.582 0.006v-1.661z"></path>
                <path
