         ...
         $(document).ready(function () {
             ...
             $('#btnAddReserve').click(function () {
                ...
                reserve.reserve_q5=$("input:radio[name=reserve_q5]:checked").val();
                 ...
                 $.ajax({
                     url: 'http://localhost:8080/inhouse/reserve/addForm',
                     method: 'POST',
                     data: reserveJSON,
                                    ...
                                    <ul class="navbar-nav hover-menu main-menu px-0 mx-xl-n4">
                                        ...
                                        <li aria-haspopup="true" aria-expanded="false"
                                            ...
                                            <a class="nav-link  p-0" href="#"
                                                data-toggle="/inhouse/reserve/addReserveForm">
                                                預約服務
                                                <span class="caret"></span>
                                            </a>
                                        </li>
                                            ...
                                            <div class="odr-box">
                                                ...
                                                <div class="rounded p-2 bg-light">
                                                    <div class="media mb-2 border-bottom">
                                                        <div class="media-body"> <a href="detail.html"> Lorem ipsum
                                                                dolor
                                                                sit amet</a>
                                ...
                                <tr>
                                    <td colspan="2">
                                        <div class="form-group" style="text-align:right">
                                            <button class="btn btn btn-info py-3 px-4">送出訂單
                                        </div>
                                    </td>
                                </tr>
                            </table>
