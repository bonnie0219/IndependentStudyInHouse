        ...
        ***********************************-->
            ...
            <div class="container-fluid">
                <div class="row page-titles mx-0">
                    ...
                    <div class="col-sm-6 p-md-0 justify-content-sm-end mt-2 mt-sm-0 d-flex">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active"><a href="/backend/home">首頁</a></li>
                        </ol>
                    </div>
                </div>
                    ...
                    <div class="recent-comment m-t-15">
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-success">李岳蓁</h4>
                                <p>商品管理更新......</p>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-primary">王淳弘</h4>
                                <p>會員管理更新......</p>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-primary">江彥勳</h4>
                                <p>專欄管理更新......</p>
                                <p class="comment-date">10 min ago</p>
                            </div>
                        </div>
                        ...
                        <div class="media">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-danger">陳俊源</h4>
                                <p>訂單管理更新......</p>
                        ...
                        <div class="media no-border">
                            ...
                            <div class="media-body">
                                <h4 class="media-heading text-info">徐璟文</h4>
                                <p>優惠券管理更新.....</p>
                                <div class="comment-date">Yesterday</div>
                            </div>
                        </div>
        ...
        <div class="col-xl-4 col-xxl-6 col-lg-6 col-sm-6" style="float: left;">
            <div class="card mb-3">
                ...
                <div class="card-header">
                    <h5 class="card-title">嗨~你今天過得好嗎?</h5>
                </div>
                <div class="card-body">
