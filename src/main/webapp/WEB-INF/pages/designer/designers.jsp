...
<h2 class="fs-sm-40 mb-11 text-center">設計師介紹<hr size=3 color=#C2C2FF style="FILTER: alpha(opacity=100,finishopacity=0,style=3)"></h2>
 ...
 <section class="ftco-section ftco-project bg-light" data-section="projects">
    	<div class="container-fluid px-md-5">
            ...
            <c:forEach items="${designers}" var="p">
            	
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images${p.designer_photo}" class="img-fluid" alt="Colorlib Template" style="width:300px;height:300px">
				    				<a href="/inhouse/designer/${p.designer_id}" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
			    					<h3><a href="#">${p.designer_name}</a></h3>
			    					<h6>${p.designer_location}</h6>
			    				</div>
		    				</div>
            	</div>
    	...
    	<div class="container-fluid px-md-5">
            ...
            <div class="carousel-project owl-carousel">
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/1.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/1.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/2.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/2.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/3.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/3.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/4.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/4.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/5.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/5.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
            	...
            	<div class="item">
            		<div class="project">
		    					<div class="img">
				    				<img src="/images/member/6.jpg" class="img-fluid" alt="Colorlib Template">
				    				<a href="/images/member/6.jpg" class="icon image-popup d-flex justify-content-center align-items-center">
				    					<span class="icon-expand"></span>
				    				</a>
			    				</div>
			    				<div class="text px-4">
