...
$(document).ready(function(){
	$('#ForgetPasswordBtn').click(function () {
		   ...
		   var formData = new FormData($("#formdata_forget")[0]);
		 
			     $.ajax({
					 type:'post',
					 url:'/inhouse/forgetpassword',
					 data:formData,
					 async:false,
					 cache:false,
					 contentType:false,
					 ...
					 success: function(){
// 						 alert("");
						 Swal.fire("密碼已更改,已寄出信箱");
						 $('#member_id_forget').val('');
						 
					 },
					 error: function(){
// 						 alert("");
						 Swal.fire("網頁維護中,暫時無法取得密碼");
					 }
				 })
	})
});
...
function keyinAll(){
	...
	$('#member_id').val('');
	$('#member_name1').val('guardian');
	$('#member_password').val('123');
	$('#member_gender').val('男');
	$('#member_email').val('kidd910089@gmail.com');
	$('#member_phone').val('0906900818');
	$('#member_address').val('桃園市中壢區中大路300號');
	$('#member_birthday').val('1981-07-23');
...
function keyinAll1(){
	...
	$('#exampleInputEmail1').val('guardian');
...
function keyinAll2(){
	...
	$('#member_email_forget').val('kidd910089@gmail.com');
...
function keyinAll3(){
	...
	$('#exampleInputEmail1').val('guardian1');
	$('#exampleInputPassword1').val('123');
...
<!--                                             <a class="nav-link dropdown-toggle p-0" href="/coupon/front3" data-toggle="dropdown"  style="color:black"> -->
<!--                                                 最新消息 -->
<!--                                                 <span class="caret"></span> -->
<!--                                             </a> -->
<!--                                             <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp"> -->
<!--                                                 <li class="dropdown-item dropdown dropright"> -->
<!--                                                     <a class="dropdown-link" href="/inhouse/front4" style="color:black"> -->
<!--                                                         活動訊息(優惠券) -->
<!--                                                     </a> -->
<!--                                                 </li> -->
<!--                                                 <li class="dropdown-item"> -->
...
<!--                                         <li aria-haspopup="true" aria-expanded="false" -->
<!--                                             class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-2"> -->
<!--                                             <a class="nav-link dropdown-toggle p-0" href="" style="color:black"> -->
<!--                                                 服務流程 -->
<!--                                                 <span class="caret"></span> -->
<!--                                             </a> -->
<!--                                             <ul class="dropdown-menu pt-3 pb-0 pb-xl-3 x-animated x-fadeInUp"> -->
...
<!--                                         <li aria-haspopup="true" aria-expanded="false" -->
<!--                                             class="nav-item dropdown py-2 py-xl-5 px-0 px-xl-2"> -->
<!--                                             <a class="nav-link  p-0" href="/inhouse/reserve/addReserveForm" > -->
<!--                                                 預約服務 -->
<!--                                                 <span class="caret"></span> -->
<!--                                             </a> -->
<!--                                         </li> -->
...
<li class="breadcrumb-item"><a href="/inhouse/designer"> 會員專區 </a></li>
</ol>
</nav>
</div>
</section>
        ...
        <section class="pb-11 pb-lg-15 pt-10">
            <div class="container">
                <h2 class="fs-sm-40 mb-11 text-center">會員專區 </h2>
                <div class="row no-gutters">
                    <div class="col-lg-10 mx-auto">
                        <div class="row no-gutters">
                            <div class="col-lg-6 mb-8 mb-lg-0">
<!--                                 <h3 class="fs-24 mb-6">登入</h3> -->
                                <form action="/inhouse/home" method="post" onsubmit="return validateForm()" id="loginForm">
                                    <div class="form-group mb-4">
                                        <label for="exampleInputEmail1" class="sr-only">請輸入帳號</label>
                                        <input type="text" class="form-control" id="exampleInputEmail1" name="username"
                                            placeholder="請輸入帳號">
                                    </div>
                                    <div class="form-group mb-3">
                                        <label for="exampleInputPassword1" class="sr-only">請輸入密碼</label>
                                        <input type="password" class="form-control" id="exampleInputPassword1"
                                            placeholder="請輸入密碼" name="password">
                                    </div>
                                    <a href="#forgetPasswordModal" data-toggle="modal"
                                        class="d-inline-block fs-15 border-bottom border-2x lh-12 mb-5 border-secondary border-hover-primary">忘記密碼?</a>
                                    
<!--                                     <p class="g-recaptcha" -->
<!-- 									data-sitekey="6Lf4NCgcAAAAALP_nOwaVCV3ii-_7U0YOXQ3s8F8"> -->
<!-- 									</p> -->
                                    <p><input type="button" onclick="keyinAll1()" value="guardian">&nbsp&nbsp&nbsp&nbsp<input type="button" onclick="keyinAll3()" value="guardian1"></p>
<!--                                     <input type="submit" class="btn btn-primary btn-block mb-3" value="登入"> -->
                                       <button class="g-recaptcha btn btn-primary btn-block mb-3"
                                         data-sitekey="6Ld8yo0cAAAAAFxnfPWGNKzl_remgR3CKtWz1ry9"
                                    ...
                                    <div class="custom-control custom-checkbox mb-7">
                                        <input type="checkbox" class="custom-control-input" id="customCheck1"
                                            name="remember-me">
                                        <label class="custom-control-label fs-15" for="customCheck1">記住我</label>
                                    </div>
                                    <div class="row no-gutters mx-n2">
<!--                                         <div class="col-sm-6 mb-4 mb-sm-0 px-2"> -->
<!--                                             <a href="#" class="btn btn-outline-primary btn-block text-capitalize px-3"> -->
<!--                                                 <span class="d-inline-block mr-2"><i -->
<!--                                                         class="fab fa-facebook-f"></i></span>使用FackBook登入</a> -->
<!--                                         </div> -->
<!--                                         <div class="col-sm-6 mb-4 mb-sm-0 px-2"> -->
<!--                                             <a href="#" class="btn btn-outline-primary btn-block text-capitalize px-4"> -->
...
<!--                                         </div> -->
                            ...
                            <div class="col-lg-6 pl-lg-6 pl-xl-13">
                                <h3 class="fs-24 mb-6">新會員</h3>
                                <p class="mb-6">在InHouse建立一個帳戶後，您就能夠結帳流程更快、使用預約服務，並查看和您的帳戶、訂單或更多的資訊。</p>
                                <a href="#addMemberModal" data-toggle="modal" class="btn btn-primary">註冊</a>
                            </div> 
                        </div>
                    </div>
                </div>
				...
				<form id="formdata_add">
					...
					<div class="modal-body">
						<div class="form-group">
							<label>會員編號</label><input  id="member_id" name="member_id" type="text" required disabled >
						</div>
						<div class="form-group">
							<label>會員帳號</label> <input name="member_name" id="member_name1" type="text" class="form-control"
								 required >
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label>檔案</label> <input name="file" id="file" type="file" class="form-control"
								 required onchange="loadImageFile_add(event)" >
						</div>
						
					</div>
					<div class="modal-footer">
						<input id="AddMemberBtn" type="button"  class="btn btn-primary" value="新增" data-dismiss="modal">
	...
	<div id="forgetPasswordModal" class="modal fade">
		<div class="modal-dialog">
			<div class="modal-content">
				<form id="formdata_forget">
					<div class="modal-header">
						<h4 class="modal-title" style="align:center">忘記密碼</h4>
						<button type="button" class="close" data-dismiss="modal"
							aria-hidden="true">&times;</button>
					</div>
					<div class="modal-body">
						<div class="form-group">
							<label>會員信箱</label><input  id="member_email_forget" name="member_email_forget" type="text" required >
						</div>
						<p><input type="button" onclick="keyinAll2()" value="一鍵輸入"></p>				
					</div>
					<div class="modal-footer">
						<input id="ForgetPasswordBtn" type="button"  class="btn btn-primary" value="送出" data-dismiss="modal">
						<input type="button" class="btn btn-default" data-dismiss="modal"
							value="取消"> 
					</div>
				</form>
            ...
            <div class="card border-0 pt-5 pb-7 h-100">
                ...
                <div class="card-footer mt-auto border-0 bg-transparent px-6 pb-0 pt-5">
                    <div class="d-flex align-items-center mb-4">
                        <span class="font-weight-bold text-primary">總金額</span>
                        <span class="d-block ml-auto text-primary">$0.00</span>
                    </div>
                    <input type="text" class="form-control w-100 text-primary mb-4"
                        placeholder="Enter coupon code here">
                    <input type="submit" class="btn btn-primary btn-block mb-2" value="結帳">
                    <a href="#" class="d-block fs-14 text-uppercase letter-spacing-05 text-center font-weight-bold">檢視購物車</a>
                </div>
            </div>
        </form>
    </div>
