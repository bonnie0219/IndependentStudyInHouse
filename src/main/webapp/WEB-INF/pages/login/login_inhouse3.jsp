...
<!--                                 <form action="/inhouse/home" method="post"> -->
...
<!--                                     <input type="submit" class="btn btn-primary btn-block mb-3" value="送出"> -->
...
<!--                                 <p class="mb-6">在網站建立一個帳戶後，您就能夠結帳流程更快、使用預約服務，並查看和您的帳戶、訂單或更多的資訊。</p> -->
...
<!-- 						</div> -->
<!-- 						<div class="form-group"> -->
<!-- 							<label>會員名字</label> <input name="member_name" id="member_name" type="text" class="form-control" -->
<!-- 								 required> -->
<!-- 						</div> -->
<!-- 						<div class="form-group"> -->
...
<!-- 						</div> -->
<!-- 						<div class="form-group"> -->
<!-- 							<label>會員照片</label> <input name="member_photo" id="member_photo" type="text" class="form-control" -->
<!-- 								 required disabled > -->
<!-- 						</div> -->
<!-- 						<div class="form-group"> -->
