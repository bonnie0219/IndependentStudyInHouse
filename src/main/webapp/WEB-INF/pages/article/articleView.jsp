...
<%@ page language="java" import="tw.InHouse.article_model.Article"%>
...
<li class="breadcrumb-item active" aria-current="page">專欄介紹</li>
</ol>
</nav>
</div>
</section>
...
<h2 class="fs-sm-40 mb-11 text-center">專欄介紹<hr size=3 color=#C2C2FF style="FILTER: alpha(opacity=100,finishopacity=0,style=3)"></h2>


<section class="pt-10 pb-11 pb-lg-15">
<div class="container">
  <%     //import arraylist and modelbean
       //  String a= "/Inhouse/article/articleView/getall";
         ArrayList<Article> list = (ArrayList<Article>)request.getAttribute("theColumnBean");  //取出所儲存的資料
...
<h2 class="fs-sm-40 mb-11 text-center">現在沒有新增任何文章</h2>
</c:if>

<div class="row" style="vertical-align:top;" >
<c:forEach var="p" items="${theColumnBean}" begin="<%=page_begin%>" end="<%=page_end%>">
...
<a href="/inhouse/article/articleView/${p.article_id}" class="hover-shine card-img-top"
style="display:inline-block;width:100%;height:250px;">
<img src="${p.article_image}" alt="image error">
</a>
...
<h3 class="card-title mb-3 fs-20">
    <!--連結加上標題-->
<a href="/inhouse/article/articleView/${p.article_id}">${p.article_title}</a>
</h3>
<!--<p class="card-text mb-4">${p.article.substring(0,10)}...</p>  -->

<a href="/inhouse/article/articleView/${p.article_id}" class="fs-14 font-weight-bold border-bottom border-light-dark text-uppercase letter-spacing-05 d-inline-block border-hover-primary">
Read more
</a>
</div>
</div>
...
<li class="page-item" id="ss"><a class="page-link" href="${a}?begin=${sessionScope.page_current-2}">${sessionScope.page_current-2}</a></li>
</c:if>
<c:if test="${sessionScope.page_current-1>0}">
...
<c:if test="${sessionScope.total_count!=0}">
Now Page : ${sessionScope.page_current } / ${sessionScope.page_total } 共:${total_count}篇精選專欄
